...
def get_parser():
    ...
    parser.add('--num_splits', type=int, default=8, help="Number of splits done for cross validation")
    parser.add('--shuffle', action="store_true", help="Shuffle data during cross-validation")
    parser.add('--seed', type=int, default=42, help="Seed for KFold initialization.")
